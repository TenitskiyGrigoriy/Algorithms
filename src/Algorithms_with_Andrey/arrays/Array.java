 ...
 *
 * Input data
 * First, the number N is given — the number of elements in the array (1≤N≤100). Next, N numbers are written separated by a space — the elements of the array.
 * The array consists of integers.
 *
 * Output data
