...
/**
 * It is required to determine whether it is possible to break off k lobules from a chocolate bar with a size of n × m lobules, if it is allowed to make one break in a straight line between the lobules (that is, to break the chocolate bar into two rectangles).
 *
 * Input data
